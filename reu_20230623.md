...
* Idée de première animation: Faire des erreurs dans un projet github et le resoudre. Par exemple effacer un fichier et le réétablir à une date précédente
